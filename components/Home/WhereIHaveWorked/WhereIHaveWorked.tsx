...
export default function WhereIHaveWorked() {
  const GetDescription = () => {
    switch (DescriptionJob) {
      case "Strongwill I.T. Solutions":
        return <EnsVision />;
      case "Comfac Technology Options Limited":
        return <YpredictAI />;
      case "PRL BPO Technology Corp.":
        return <TrouveTavoie />;
      case "Traxion Tech Inc.":
        return <SuperBerry />;
      case "ETHOS Innovation Inc.":
        return <EnergyInstitute />;
    }
  };
  const [DescriptionJob, setDescriptionJob] = React.useState(
    "ETHOS Innovation Inc."
  );
  return (
    <div
      data-aos="fade-up"
      ...
      <div className="flex flex-col md:order-2 order-1 space-y-1 pl-8 md:pl-0 ">
        <div className="flex flex-row md:flex-col">
          <CompanyButton
            ...
            CompanyName="ETHOS Innovation Inc."
            BarPosition={-10}
            BarAvobePosition={1}
            DescriptionJob="ETHOS Innovation Inc."
            CompanyNameBackgroundColorGreen={[
              true,
              false,
              false,
          ...
          <CompanyButton
            ...
            CompanyName="Comfac Technology Options Limited"
            BarPosition={80}
            BarAvobePosition={256}
            DescriptionJob="Comfac Technology Options Limited"
            CompanyNameBackgroundColorGreen={[
              false,
              false,
              true,
          ...
          <CompanyButton
            ...
            CompanyName="Strongwill I.T. Solutions"
            BarPosition={36}
            BarAvobePosition={128}
            DescriptionJob="Strongwill I.T. Solutions"
            CompanyNameBackgroundColorGreen={[
              false,
              true,
              false,
          ...
          <CompanyButton
            ...
            CompanyName="PRL BPO Technology Corp."
            BarPosition={168}
            BarAvobePosition={512}
            DescriptionJob="PRL BPO Technology Corp."
            CompanyNameBackgroundColorGreen={[
              false,
              false,
              false,
          ...
          <CompanyButton
            ...
            CompanyName="Traxion Tech Inc."
            BarPosition={342}
            BarAvobePosition={1024}
            DescriptionJob="Traxion Tech Inc."
            CompanyNameBackgroundColorGreen={[
              false,
              false,
              false,
