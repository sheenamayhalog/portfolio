      ...
      <div className="flex flex-col xl:space-y-36 space-y-8 md:space-y-28">
              ...
              <div className="w-full md:bg-AAtertiary rounded-md py-6 md:p-6  z-10">
                <p className="text-gray-200 md:text-gray-200 text-left md:text-left ">
                  ...
                  <a
                    target="_blank"
                    rel="noreferrer"
                    href="https://www.tingogadmin.com/"
                    className="text-AAsecondary"
                  >
                    Tingog
                  </a>
                  ...
                  <a
                    target="_blank"
                    rel="noreferrer"
                    href="https://www.halalan2022.com"
                    className="text-AAsecondary"
                  >
                    Eleksyon
                  </a>
            ...
            >
              ...
              <div className="w-full md:bg-AAtertiary rounded-md py-6 md:p-6  z-10">
                <p className="text-gray-200 md:text-gray-200 text-left md:text-right">
                  ...
                  microservices architecture, and Docker for scalable and
        ...
        >
          ...
          >
            <div className="relative rounded w-full h-full col-start-6 col-span-7 ">
              <a
                href={"https://app.finalehealth.com/"}
                target="_blank"
                rel="noreferrer"
              >
                <div
            ...
            >
              ...
              <div className="w-full md:bg-AAtertiary rounded-md py-6 md:p-6  z-10">
                <p className="text-gray-200 md:text-gray-200 text-left">
                  ...
                  team that help clients import data from their previous systems
                  into Finale.
                </p>
              </div>
              <ul
            ...
            >
              ...
              <div className="w-full md:bg-AAtertiary rounded-md py-6 md:p-6  z-10">
                <p className="text-gray-200 md:text-gray-200 text-left md:text-right">
                  ...
                  social media platforms in which I played a key role in
            ...
            >
              ...
              <div className="w-full md:bg-AAtertiary rounded-md py-6 md:p-6  z-10">
                <p className="text-gray-200 md:text-gray-200 text-left ">
                  ...
                  members that utilizes microservices and payment gateways
                  integration.
                </p>
              </div>
              <ul
