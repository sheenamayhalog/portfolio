...
const IconsData = [
  { href: "https://github.com/sheenamayhalog", Icon: GithubIcon },
  {
    href: "https://www.linkedin.com/in/sheena-may-halog/",
    Icon: LinkedinIcon,
  },
];
  ...
  return (
    <div className="bg-AAprimary flex flex-col justify-center items-center py-8 space-y-4">
      ...
      <a href={props.githubUrl} className="" target={"_blank"} rel="noreferrer">
        <div className="group flex flex-col font-mono justify-center items-center text-gray-200 text-sm space-y-2">
          <span className="group-hover:text-AAsecondary sm:text-sm text-xs">
            Built by Sheena May Halog
          </span>

          <span className="text-xs flex flex-row items-center space-x-2 group-hover:text-AAsecondary">
            <GithubIcon className="w-4 h-4 text-gray-200 fill-current group-hover:text-AAsecondary" />
